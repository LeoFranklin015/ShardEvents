    ...
    <div className="flex justify-center items-center h-screen bg-black text-white">
      <div className="flex-1 flex flex-col justify-center items-start px-8">
        <div className="max-w-md">
          ...
          <h1 className="text-6xl mb-4 font-bold">ShardEvents</h1>

          {/* Gap between title and description */}
          <div className="mb-6"></div>

          <p className="mb-6 text-lg text-gray-400">
            Discover and organize events related to shardeum blockchain.
            ShardEvents is your gateway to the exciting world of decentralized
